        ...
        <div className="flex flex-col lg:flex-row gap-20 items-stretch">
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 min-h-[600px]">
            ...
            {profiles.map((profile, i) => (
              ...
              <div key={i} className="bg-gradient-to-r from-[#C9A227] via-[#FFD700] to-[#B8962E] p-[3px] rounded-[2.5rem] shadow-xl">

                <div className="group relative overflow-hidden rounded-[2.5rem] md:h-full min-h-[500px]">
            ...
            <a 
              ...
              className="bg-purple-600 rounded-[2.5rem] p-8 text-white flex flex-col justify-center items-center text-center shadow-xl hover:bg-purple-700 transition-all cursor-pointer group"
            >
