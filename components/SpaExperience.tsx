...
const SpaExperience: React.FC = () => {
  ...
  // vídeo hospedado no Supabase
  const [videoSrc] = useState(
    "https://snxpdzgfyzkazbnnmegt.supabase.co/storage/v1/object/public/videos/video-teste.mp4"
  );
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="inline-block px-4 py-1.5 bg-purple-100 text-purple-700 rounded-full text-xs font-bold uppercase tracking-widest">
                Experiência Sensorial
              </div>

              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                💙 Uma experiência exclusiva que transforma o seu cão
              </h2>

              <p className="text-xl text-gray-600 leading-relaxed">
                Trazer seu cão ao Spa Low Stress é oferecer muito mais do que higiene — é investir na saúde física e mental dele.
              </p>
          ...
          <div className="flex-1 w-full lg:max-w-xl relative">
            ...
            {showAdmin && (
              ...
              <div className="absolute -top-12 left-0 right-0 flex justify-center gap-2 z-30 animate-fade-in">
                ...
                <button
                  ...
                  className="bg-white text-pink-600 px-4 py-2 rounded-full text-xs font-bold shadow-xl border flex items-center gap-2 hover:bg-pink-50"
                >
            ...
            <div className="relative group rounded-[3rem] overflow-hidden shadow-2xl w-[640px] h-[360px] mx-auto bg-gray-200 border-8 border-transparent bg-gradient-to-r from-[#C9A227] via-[#FFD700] to-[#B8962E]">
