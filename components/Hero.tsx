...
const Hero: React.FC = () => {
  ...
  // agora começa vazio (somente imagem do admin)
  ...
  useEffect(() => {
    const loadAssets = async () => {
      try {
        ...
        console.warn('Erro ao carregar assets do Supabase:', err);
      }
    };
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // nova imagem substitui automaticamente a anterior
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-gradient-to-br from-violet-300 via-purple-200 to-purple-400">
      <div className="absolute top-20 right-0 w-[400px] h-[400px] bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob"></div>
      <div className="absolute bottom-20 left-0 w-[400px] h-[400px] bg-pink-300 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob animation-delay-2000"></div>
      ...
      <div className="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <a 
              ...
              className="px-8 py-4 bg-purple-600 text-white rounded-full font-bold shadow-lg hover:shadow-purple-500/30 hover:scale-105 transition-all flex items-center justify-center gap-2"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 bg-white text-gray-800 border border-gray-200 rounded-full font-bold hover:border-purple-300 hover:text-purple-600 transition-all shadow-sm flex items-center gap-2"
            >
              <Heart size={18} className="text-pink-500" /> Agendar Banho
            </a>
        ...
        <div className="relative group">
          ...
          <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-700 border-4 border-transparent bg-gradient-to-r from-[#C9A227] via-[#FFD700] to-[#B8962E] w-96 h-96 mx-auto">
